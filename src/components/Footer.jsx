...
const Footer = ({ theme }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-3
    sm:px-24 xl:px-40"
    >
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <ul className="flex gap-8">
            ...
            <li>
              <a className="hover:text-primary" href="#out-work">
                Our Work
              </a>
            </li>
            <li>
      ...
      >
        <p>Copyright 2026 &copy; greatStack - All Right Reserved.</p>
